...
import type { GroupByType, LookAndFeel, SortDirection } from './@types/tasklist';
  ...
  private buildSettings() {
    ...
    new Setting(this.containerEl)
      ...
      .addDropdown((dropdown) => {
        ...
        dropdown.onChange(async (value: string) => {
          await this.plugin.updateSettings({ sortDirectionItems: value as SortDirection });
        });
      })
    ...
    new Setting(this.containerEl)
      ...
      .addDropdown((dropdown) => {
        ...
        dropdown.onChange(async (value: string) => {
          await this.plugin.updateSettings({ sortDirectionGroups: value as SortDirection });
        });
      })
